...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 30, 2024 at 07:12 PM
...
--
ALTER TABLE `users`
  MODIFY `shms_sn` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Shms Serial Number to organize users by ascending or descending', AUTO_INCREMENT=17;
