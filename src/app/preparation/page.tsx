...
export default function Preparation() {
  return (
    <Layout>
      ...
      >
        <h1 className='text-3xl'>التحضير للموسم الزراعي</h1>
        ...
        <div dir='rtl' style={{ marginTop: 100, justifyContent: 'center' }}>
          ...
          <p style={{ fontSize: 20 }}>
            ...
            إعداد البيئة المثلى لنمو النباتات، وتعزز امتصاص الأسمدة والماء، وتقلل من تواجه
            الأمراض والآفات. في هذا المقال، سنستعرض الخطوات الرئيسية والممارسات الفعّالة
            لتحضير الأرض قبل الزراعة.
          </p>
          ...
          <h3 style={{ fontSize: 30, fontWeight: 'bold' }}>2. إزالة الحشائش والمخلفات</h3>
          <p style={{ fontSize: 20 }}>
            يجب إزالة الحشائش والمخلفات النباتية من سطح الأرض قبل البدء في تحضيرها.
            فالحشائش يمكن أن تنافس النباتات المزروعة على الموارد وتقلل من كفاءة الإنتاجية،
            بينما تقلل المخلفات من جودة التربة وتزيد من احتمال تواجد الآفات والأمراض.
          </p>
