  ...
  return (
    <main className="rtl flex min-h-screen flex-col gap-y-10 p-2.5 md:p-16">
      ...
      <section className="mt-10 leading-loose md:text-justify">
        ...
        <p>
          من خلال استخدام موقعنا، فإنك توافق على استخدام ملفات تعريف الارتباط وفقًا لسياسة الخصوصية
          الخاصة بنا.
        </p>
        <p>نحن نحترم خصوصيتك ونضمن أمان بياناتك الشخصية وفقًا للوائح والتشريعات السارية.</p>
        <p>
          لمزيد من المعلومات حول كيفية استخدامنا لملفات تعريف الارتباط، يرجى قراءة سياسة الخصوصية
          الخاصة بنا.
        </p>
        <p>شكرًا لاختيارك استخدام موقعنا!</p>
        <p>
          يمكنك العثور على مزيد من المعلومات حول سياسة ملفات تعريف الارتباط في الوصلة التالية:{" "}
          <Link
