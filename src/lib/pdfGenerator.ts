...
export async function generatePDFContent({
  ...
  return `
    ...
    <body style="max-width: 750px; padding: 10px; margin: 0 auto; background-color: #fff; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); font-family: Arial, sans-serif;">
...
export async function generatePDF({
  ...
  profitsCollectDate,
  referenceCode
}: generatePDFProps): Promise<string> {
